    ...
    <div class="top-bar mobile_hide" bis_skin_checked="1">
        ...
        <div class="container-fluid" bis_skin_checked="1">
            ...
            <div class="row align-items-center justify-content-between g-2 ">
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-center flex-wrap ">
                    <span class="me-3 d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-telephone-outbound" viewBox="0 0 16 16">
                    ...
                    <span class="d-flex align-items-center g-2 mobile_hide">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-envelope-paper-heart" viewBox="0 0 16 16">
                ...
                <div class="col-lg-7 col-md-6  mobile_hide">
                            ...
                            <p class="text-light mb-0">We are a Proprietorship owned entity which is performing its occupational activities in a proficient manner in the field of wholesaling.</p>
                ...
                <div class=" mobile_hide col-lg-2 col-md-6 d-flex justify-content-lg-end justify-content-center ">
                    <ul class="social list-unstyled mb-0">
                        <li><a href="f" target="_blank" title="Facebook"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff
#ffffff" class="bi bi-facebook" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
                                </svg></a></li>
                        <li><a href="i" target="_blank" title="Instagram"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff
#ffffff" class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <li><a href="y" target="_blank" title="YouTube"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff
#ffffff" class="bi bi-youtube" viewBox="0 0 16 16">
                        ...
                        <li><a href="x" target="_blank" title="pintrest"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff
#ffffff" class="bi bi-pinterest" viewBox="0 0 16 16">
            ...
            <div class="d-flex justify-content-between gap-2 align-items-center" bis_skin_checked="1">
                <div class="logo" bis_skin_checked="1">
                    <a href="index.php" title="#">
                        <img src="./designer/images/logo.jpg" alt="lorem" title="lorem">
                    </a>
                </div>
                <form class="mobile_hide" action="#" method="#">

                              <div class="search-bx">

                                  <input type="text" placeholder="I am looking for..." name="search" required="">
                ...
                <div class="navigation" bis_skin_checked="1">
                    ...
                    <div class="menu main_header" bis_skin_checked="1">
                        <ul class="nav">
                            ...
                            <li class="laptop-hide"><a href="blog.php" title="Blog">Blog</a></li>
                            <li class="laptop-hide"><a href="faq.php" title="Faq">Faq</a></li>
